...
all_products = list(
    filter(lambda p: p['price'] != "N/A" and p['link'] != "N/A" and p['title'] != "N/A", products))

channel.queue_declare(queue=queue_name)
channel.basic_publish(exchange='', routing_key=queue_name, body=json.dumps(all_products))

print(" Send 'Product data' to RabbitMQ")
