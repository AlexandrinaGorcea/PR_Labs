...
app.config['SQLALCHEMY_DATABASE_URI'] = 'postgresql://postgres:alexandrina@localhost:5432/makeup_db'  # item 7
# app.config['SQLALCHEMY_DATABASE_URI'] = 'postgresql://postgres:alexandrina@db:5432/makeup_db'  # 8
